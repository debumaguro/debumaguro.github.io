...
var Runewords = [
  ...
  {title:"Rhyme<br>운율</br>",runes:['Shael','Eth'],ttype:"방패"},
  {title:"Silence<br>침묵</br>",runes:['Dol','Eld','Hel','Ist','Tir','Vex'],ttype:"무기"},
  {title:"Smoke<br>연기</br>",runes:['Nef','Lum'],ttype:"갑옷"},
  {title:"Stealth<br>은신</br>",runes:['Tal','Eth'],ttype:"갑옷"},
  {title:"Steel<br>강철</br>",runes:['Tir','El'],ttype:"검/도끼/메이스"},
  {title:"Strength<br>완력</br>",runes:['Amn','Tir'],ttype:"근접 무기"},
  {title:"Venom<br>맹독</br>",runes:['Tal','Dol','Mal'],ttype:"무기"},
  {title:"Wealth<br>부유함</br>",runes:['Lem','Ko','Tir'],ttype:"갑옷"},
  {title:"White<br>화이트</br>",runes:['Dol','Io'],ttype:"완드"},
  {title:"Zephyr<br>서풍</br>",runes:['Ort','Eth'],ttype:"원거리 무기"},
	/* 1.10 */
  ...
  {title:"Call To Arms<br>소집 명령</br>",runes:['Amn','Ral','Mal','Ist','Ohm'],ttype:"무기"},
  {title:"Chaos<br>혼돈</br>",runes:['Fal','Ohm','Um'],ttype:"클러"},
  {title:"Chains of Honor<br>명예의 굴레</br>",runes:['Dol','Um','Ber','Ist'],ttype:"갑옷"},
  {title:"Crescent Moon<br>초승달</br>",runes:['Shael','Um','Tir'],ttype:"도끼/검/창/폴암"},
  {title:"Delirium<br>정신착란</br>",runes:['Lem','Ist','Io'],ttype:"투구"},
  {title:"Doom<br>파멸</br>",runes:['Hel','Ohm','Um','Lo','Cham'],ttype:"도끼/창/폴암/해머"},
  ...
  {title:"Hand of Justice<br>정의의 손</br>",runes:['Sur','Cham','Amn','Lo'],ttype:"무기"},
  {title:"Heart of the Oak<br>떡갈나무의 심장</br>",runes:['Ko','Vex','Pul','Thul'],ttype:"스태프*/메이스"},
  ...
  {title:"Destruction<br>파괴</br>",runes:['Vex','Lo','Ber','Jah','Ko'],ttype:"창/폴암/검",ladder:true},
  {title:"Dragon<br>용</br>",runes:['Sur','Lo','Sol'],ttype:"갑옷/방패",ladder:true},
  ...
  {title:"Infinity<br>무한의 공간</br>",runes:['Ber','Mal','Ber','Ist'],ttype:"창/폴암",ladder:true},
  {title:"Insight<br>통찰력</br>",runes:['Ral','Tir','Tal','Sol'],ttype:"창/폴암/스태프",ladder:true},
  {title:"Last Wish<br>마지막 소원</br>",runes:['Jah','Mal','Jah','Sur','Jah','Ber'],ttype:"검/해머/도끼",ladder:true},
  {title:"Lawbringer<br>법률집행자</br>",runes:['Amn','Lem','Ko'],ttype:"검/해머/셉터",ladder:true},
  {title:"Oath<br>서약</br>",runes:['Shael','Pul','Mal','Lum'],ttype:"검/도끼/메이스",ladder:true},
  {title:"Obedience<br>순종</br>",runes:['Hel','Ko','Thul','Eth','Fal'],ttype:"창/폴암",ladder:true},
  ...
  {title:"Plague<br>역병</br>",runes:['Cham','Fal','Um'],ttype:"무기",ladder:true},
    /* 1.11 */
    {title:"Bone<br>뼈</br>",runes:['Sol','Um','Um'],ttype:"갑옷<span class=\"small\">(네크로맨서)</span>",tclass:"Necromancer"},
